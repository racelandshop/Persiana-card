...
import { getLightCurrentModeRgbColor, LightColorModes, LightEntity, lightIsInColorMode, lightSupportsColor, lightSupportsColorMode, lightSupportsDimming, SUPPORT_EFFECT, } from "./data/blind";
import { css, CSSResultGroup, html, LitElement, PropertyValues, TemplateResult, } from "lit";
import { customElement, property, state } from "lit/decorators";
import memoizeOne from "memoize";
import { supportsFeature } from "./common/entity/supports-feature";

@customElement("more-info-blind2")
class MoreInfoBlind extends LitElement {
    ...
    declare global {
      interface HTMLElementTagNameMap {
        "more-info-light2": MoreInfoBlind;
    }
}
